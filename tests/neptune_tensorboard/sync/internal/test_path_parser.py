...
class PathParserTest(unittest.TestCase):
    def test_parsing_experiment_name(self):
        # GIVEN
        test_cases = [
            ("events.out.tfevents.1551714927.jan-kowalski-pascal05-test-4vgt2", "untitled-tensorboard"),
            ("deepsense/events.out.tfevents.1551714927.jan-kowalski-pascal05-test-4vgt2", "deepsense"),
            ("deepsense/events.out.tfevents.1551719327.adam-timing-signal-benchmark11-worker-0", "deepsense"),
            ("deepsense/events.out.tfevents.1552057986.adam-sem-prevents-overfit-hypothesis-05-worker-0", "deepsense"),
            (
            ...
            ("mnist/something", "mnist"),
            ("mnist", "untitled-tensorboard"),
        ]
    ...
    def test_parsing_hostname(self):
        # GIVEN
        test_cases = [
            ("events.out.tfevents.1551714927.jan-kowalski-pascal05-test-4vgt2", "jan-kowalski-pascal05-test-4vgt2"),
            (
            ...
            ("mnist/logs/mnist_with_summaries/test/events.out.tfevents.1551288692.adam-nowak", "adam-nowak"),
            ("mnist/logs/mnist_with_summaries/train/events.out.tfevents.1551288692.piotr-adamski", "piotr-adamski"),
            ("mnist/something", None),
            ("mnist/data/events.out.tfevents.piotr-adamski", None),
        ]
