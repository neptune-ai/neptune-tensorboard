...
class TensorflowDataSync(object):
    ...
    def _load_single_run(self, path):
        ...
        # Ignore files generated by Tensorboard plugins as
        # those do not correspond to Tensorlfow runs
        # and as such can be considered rubbish.
        if run_path.startswith('train/plugins') or run_path.endswith('profile-empty'):
            return
